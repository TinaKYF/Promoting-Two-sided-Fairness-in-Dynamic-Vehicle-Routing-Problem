...
class GaClusterOfficer:
    ...
    def execute(self):
        ...
        fileName = 'Fair_cluster_officer_result.csv'
        titles = ['runTime', 'stopTime', 'startTime', 'endTime', 'updateTime', 'popuSize', 'crossRate', 'mutateRate',
                  ...
                  'officerdis_record', 'stdofficerdis_record', 'area_vionum', 'area_capnum', 'area_caprate',
                  'stdarea_caprate']
        params = [runTime, stopTime, self.startTime, self.endTime, self.updateTime, self.populationSize, self.crossRate,
                  ...
                  self.validCapturedTime, officerdis_record, stdofficerdis_record, self.area_list, self.area_cap_list,
